...
{
    Mesh *obj1 = new Mesh();
    bool loaded = obj1->CreateMeshFromOBJ("Models/untitled1.obj");
    if (loaded)
    {
        for (int i = 0; i < 10; i++)
        {
...
int main()
{
    ...
    unsigned char *data = stbi_load("Textures/steve.png", &width, &height, &nrChannels, 0);
    if (data)
    {
        // bind image with texture jpg -> Gl_RGB , png -> RGBA
